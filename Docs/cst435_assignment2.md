...
### Group Members:
1. Name: _________________ Matric No.: _________________
2. Name: _________________ Matric No.: _________________
3. Name: _________________ Matric No.: _________________
...
**Dataset:** You will use the Food-101 dataset for this assignment:
https://www.kaggle.com/datasets/dansbecker/food-101

**Note:** You do not need to use all images. Create manageable subsets for testing.
